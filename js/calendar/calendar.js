...
var data = [],
    ...
    h, 
    m,
    names = ['Grand parcours', 'Parcours moyen','Petit parcours'],
    slipsum = ['Voici la description de votre grand parcours. Quelque chose d\'interessant à dire?',
               'Voici la description de votre parcours moyen. Quelque chose d\'interessant à dire?',
               'Voici la description de votre petit parcours. Quelque chose d\'intéressant à ajouter?'];


// Script to generate random datas
       /*for(i = 0; i < 25; i++) {
   ...
   data.push({ title: names[0], start: new Date(2015, 10-1, 19, 6, 30), end: new Date(2015, 10-1, 19, 16, 30), allDay: !(1), text: slipsum[0]  });
   data.push({ title: names[2], start: new Date(2015, 10-1, 21, 14, 02), end: new Date(2015, 10-1, 21, 16, 30), allDay: !(1), text: slipsum[2]  });
