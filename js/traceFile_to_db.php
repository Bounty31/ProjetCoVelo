...
for ($i=0; $i < $tailleTrace ; $i++) { 
	//insertion
	$bdd->query("INSERT INTO trace VALUES (".$lastID.", ".$_POST['trace']['altitude'][$i].", ".$_POST['trace']['distance'][$i].",".$_POST['trace']['vitesse'][$i].",".$_POST['trace']['freq_cardiaque'][$i].",".$_POST['trace']['delta_temps'][$i].",".$_POST['trace']['puissance'][$i].",".$_POST['trace']['freq_pedalage'][$i].");");
}
